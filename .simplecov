# kettle-jem:freeze
# To retain chunks of comments & code during activesupport-broadcast_logger templating:
# Wrap custom sections with freeze markers (e.g., as above and below this comment chunk).
# activesupport-broadcast_logger will then preserve content between those markers across template runs.
# kettle-jem:unfreeze
