...
gem_version =
  if Gem.ruby_version >= Gem::Version.new("3.1")
    ...
    Module.new.tap { |mod| Kernel.load("#{__dir__}/lib/activesupport/broadcast_logger/version.rb", mod) }::Activesupport::BroadcastLogger::Version::VERSION
  else
    require_relative "lib/activesupport/broadcast_logger/version"
    Activesupport::BroadcastLogger::Version::VERSION
  end
...
Gem::Specification.new do |spec|
  ...
  spec.homepage = "https://github.com/galtzo-floss/activesupport-broadcast_logger"
  spec.licenses = ["MIT"]
  ...
  spec.metadata["homepage_uri"] = "https://github.com/pboling/activesupport-broadcast_logger"
  ...
  package_metadata_files = %w[
    ...
    LICENSE.md
    README.md
    sig/activesupport/broadcast_logger.rbs
  ...
  spec.add_development_dependency("kettle-dev", "~> 2.5", ">= 2.5.17")             # ruby >= 2.7.0
